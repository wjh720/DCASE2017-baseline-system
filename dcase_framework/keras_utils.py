...
class KerasMixin(object):
    ...
    def prepare_activity(self, activity_matrix_dict, files, processor='default'):
        ...
        for item in files:
            ...
            pdata.append(ve[0].reshape(1, 15).repeat(62, axis = 0))
            #pdata.append(ve)
...
>>>>>>> origin/master
        ...
        Conv_3 = Conv2D(32, (3, 3), padding='same', activation='relu')
        Conv_4 = Conv2D(32, (3, 3), padding='same', activation='relu')
        ...
        conv_11_input = Conv_11(pool_5_input)
        ...
        Conv_8 = Conv2D(128, (1, 1), padding='same', activation='relu')
        ...
        Conv_9 = Conv2D(128, (1, 1), padding='same', activation='relu')
