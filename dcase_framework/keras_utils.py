...
class KerasMixin(object):
    ...
    def prepare_activity(self, activity_matrix_dict, files, processor='default'):
        ...
        for item in files:
            ...
            pdata.append(ve[0].reshape(1, 15).repeat(230, axis = 0))
            #pdata.append(ve)
...
>>>>>>> origin/master
        ...
        Conv_4 = Conv1D(64, 3, padding='causal', activation='relu',dilation_rate=8)
        Conv_5 = Conv1D(64, 3, padding='causal', activation='relu',dilation_rate=16)
        ...
        Conv_15 = Conv1D(64, 3, padding='causal', activation='relu',dilation_rate=128)
        Conv_16 = Conv1D(64, 3, padding='causal', activation='relu',dilation_rate=256)
