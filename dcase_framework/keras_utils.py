...
>>>>>>> origin/master
        ...
        batch_2_input = BatchNormalization()(conv_2_input)
        pool_1_input = Pool_1(batch_2_input)
        ...
        batch_3_input = BatchNormalization()(conv_3_input)
        conv_4_input = Conv_4(batch_3_input)
        batch_4_input = BatchNormalization()(conv_4_input)
        pool_2_input = Pool_2(batch_4_input)
        ...
        batch_5_input = BatchNormalization()(conv_5_input)
        conv_6_input = Conv_6(batch_5_input)
        batch_6_input = BatchNormalization()(conv_6_input)
        pool_3_input = Pool_3(batch_6_input)
        drop_3_input = Dropout(0.2)(pool_3_input)

        Conv_7 = Conv2D(128, (3, 3), activation='relu')
        conv_7_input = Conv_7(drop_3_input)
        batch_7_input = BatchNormalization()(conv_7_input)
        drop_4_input = Dropout(0.2)(batch_7_input)

        Conv_8 = Conv2D(128, (1, 1), activation='relu')
        conv_8_input = Conv_8(drop_4_input)
        batch_8_input = BatchNormalization()(conv_8_input)
        drop_5_input = Dropout(0.2)(batch_8_input)

        Conv_9 = Conv2D(15, (1, 1), activation='relu')
        conv_9_input = Conv_8(drop_5_input)
        batch_9_input = BatchNormalization()(conv_9_input)
        #drop_3_input = Dropout(0.2)(conv_6_input)

        Pool_4 = AveragePooling2D(pool_size=(2, 2))
        pool_4_input = Pool_4(batch_9_input)
